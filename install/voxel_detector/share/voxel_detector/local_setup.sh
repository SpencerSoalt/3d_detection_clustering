...
: ${AMENT_CURRENT_PREFIX:="/ws/install/voxel_detector"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/voxel_detector/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/voxel_detector/environment/path.sh"
